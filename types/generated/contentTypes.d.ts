...
export interface ApiBiteBite extends Schema.CollectionType {
  ...
  attributes: {
    ...
    createdBy: Attribute.Relation<'api::bite.bite', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::bite.bite', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiImpressionImpression extends Schema.CollectionType {
  ...
  attributes: {
    ...
    users_permissions_user: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    bite: Attribute.Relation<
      'api::impression.impression',
      'oneToOne',
      'api::bite.bite'
    >;
    type: Attribute.Enumeration<['favorite', 'interested', 'pass', 'never']> &
      Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiSourceSource extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required & Attribute.Unique;
    location: Attribute.Component<'venue-metadata.location'> &
      Attribute.Required;
    cuisines: Attribute.Relation<
      'api::source.source',
      'manyToMany',
      'api::cuisine.cuisine'
    >;
    marqueeImage: Attribute.Media<'images'>;
    deliveryOptions: Attribute.Component<'venue-metadata.delivery-options'>;
    contactLinks: Attribute.Component<'venue-metadata.contact-links'>;
    bites: Attribute.Relation<
      'api::source.source',
      'oneToMany',
      'api::bite.bite'
